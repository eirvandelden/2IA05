...
--TODO: Add 4block rule
bla = True

subblock1 :: Pos -> Pos -> Bool
subblock1 (i,j) (k,l) = (i > 0 && i < 4) && (j > 0 && j < 4) && (k > 0 && k < 4) && (l > 0 && l < 4)
subblock2 (i,j) (k,l) = (i > 0 && i < 4) && (j > 4 && j < 8) && (k > 0 && k < 4) && (l > 4 && l < 8)
subblock3 (i,j) (k,l) = (i > 4 && i < 8) && (j > 0 && j < 4) && (k > 4 && k < 8) && (l > 0 && l < 4)
subblock4 (i,j) (k,l) = (i > 4 && i < 8) && (j > 4 && j < 8) && (k > 4 && k < 8) && (l > 4 && l < 8)
...
incident p q = row p q || column p q || block p q  || subblock1 p q   || subblock2 p q || subblock3 p q || subblock4 p q --TODO: add 4block rule
