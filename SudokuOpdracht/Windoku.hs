...
topleftblock (i,j) = elem i lowIntVal && elem j lowIntVal
toprightblock (i,j) = elem i lowIntVal && elem j highIntVal
bottomleftblock (i,j) = elem i highIntVal && elem j lowIntVal
bottomrightblock (i,j) = elem i highIntVal && elem j highIntVal


winblock (i,j) (k,l) = (topleftblock (i,j) && topleftblock (k,l)) || (toprightblock (i,j) && toprightblock (k,l)) || (bottomleftblock (i,j) && bottomleftblock (k,l)) || (bottomrightblock (i,j) && bottomrightblock (k,l))
...
incident p q = row p q || column p q || block p q  || winblock p q
